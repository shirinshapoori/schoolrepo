...
const SearchBar = ({onClick, moveModeClick}) => {
  return (
    <div className='search'> 
    <div className='icon-container'>
    <div className='box-icon' style={{marginLeft:"0%"}}>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="20px" viewBox="-2 -2 24 24"><path fill="#1472ff" d="m2.08 2l6.482 8.101A2 2 0 0 1 9 11.351V18l2-1.5v-5.15a2 2 0 0 1 .438-1.249L17.92 2zm0-2h15.84a2 2 0 0 1 1.561 3.25L13 11.35v5.15a2 2 0 0 1-.8 1.6l-2 1.5A2 2 0 0 1 7 18v-6.65L.519 3.25A2 2 0 0 1 2.08 0"/></svg>
     ...
     <div  onClick={() => onClick(true)}  className={moveModeClick ? 'box-icon border-blue' :'box-icon'}>
...
// filter select shode svg 
{/* <svg xmlns="http://www.w3.org/2000/svg" width="35px" height="35px" viewBox="-2 -2 24 24"><path fill="#ffffff" d="m2.08 2l6.482 8.101A2 2 0 0 1 9 11.351V18l2-1.5v-5.15a2 2 0 0 1 .438-1.249L17.92 2zm0-2h15.84a2 2 0 0 1 1.561 3.25L13 11.35v5.15a2 2 0 0 1-.8 1.6l-2 1.5A2 2 0 0 1 7 18v-6.65L.519 3.25A2 2 0 0 1 2.08 0"/></svg> */}